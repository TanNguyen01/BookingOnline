...
return [
    ...
    'update_failed'=> 'Loi cap nhat dich vu',
    'creation_failed'=> 'Loi them dich vu',
    'error'=> 'Đã xảy ra lỗi. Vui lòng thử lại sau.',
    'accept' => 'dich vu hop le',

    /** Validate */
    'time_required'=>'Nhập thời gian của dịch vụ',
    'name_unique' => 'tên  da ton tai',
    'name_required' => 'Vui lòng nhâp name',
    'categorie_id_required' => 'nhập id category',
    'categorie_id_integer' => 'nhập id category là kiểu số nguyên',
    'categorie_id_exists' => 'không có danh mục nào',
